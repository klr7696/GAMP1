 ...
 */
final class Version20201019105220 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE livre_compte (id INT NOT NULL, annee_ref INT NOT NULL, decret_livre VARCHAR(100) NOT NULL, adoption_date DATE NOT NULL, execution_date DATE NOT NULL, description_livre VARCHAR(255) DEFAULT NULL, creation_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, modif_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, is_activer BOOLEAN NOT NULL, is_non_supprimable BOOLEAN NOT NULL, PRIMARY KEY(id))');
