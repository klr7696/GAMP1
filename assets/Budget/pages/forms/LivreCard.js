...
const LivreCard = ({livre, borderColor='#009688'}) => {
   ...
   const hideBorder = () => {
    ...
    const goToLigne =(id) => {
        history.push(`/livress/${id}/comptes`);
    }

    return (
        <div className="col-sm-4" onMouseEnter={showBorder} onMouseLeave={hideBorder}>
            <div className="card horizontal text-center" style={{borderColor: color}}>
               ...
               <div className="card-stacked"> 
                <div className="card-content">
                    ...
                    <form onClick={() => goToLigne (livre.id)}>
                <button type="submit" className="m-r-15 btn btn-primary btn-sm btn-round">
